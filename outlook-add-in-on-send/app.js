 ...
 */
    ...
    // Add a CC to the email.  In this example, CC yashwanth.lingareddy@walmart.com
    // <param name="event">MessageSend event passed from calling function</param>
    function addCCOnSend(event) {
        mailboxItem.cc.setAsync(['yashwanth.lingareddy@walmart.com'], { asyncContext: event });        
    }
    ...
    function checkBodyOnlyOnSendCallBack(asyncResult) {
        var listOfBlockedWords = new Array("Amazon", "AWS");
        ...
        if (checkBody) {
            mailboxItem.notificationMessages.addAsync('NoSend', { type: 'errorMessage', message: 'Blocked words ("Amazon", "AWS") have been found in the body of this email. Please remove them.' });
            // Block send.
            asyncResult.asyncContext.completed({ allowEvent: false });
        }
